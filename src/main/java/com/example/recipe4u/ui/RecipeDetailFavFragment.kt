...
import com.example.recipe4u.databinding.FragmentDetailFavViewBinding

class RecipeDetailFavFragment: Fragment() {
    private lateinit var binding: FragmentDetailFavViewBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentDetailFavViewBinding.inflate(layoutInflater)
